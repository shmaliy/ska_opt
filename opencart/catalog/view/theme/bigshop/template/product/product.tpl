 ...
 <div class="image-additional">
    ...
    <h1><?php echo $heading_title; ?></h1>
     ...
     <?php if ($price) { ?>
      ...
      <?php } ?>
      <div class="cart">
        <div><?php if ($minimum > 1) : ?>
          <div class="minimum"><p><?php echo $text_minimum; ?></p></div>
     <?php endif; ?>
     <div class="qty">                  
                  <strong><?php echo $text_qty; ?></strong>
                  <a class="qtyBtn mines" href="javascript:void(0);">-</a>
                    <input id="qty" type="text" class="w30" name="quantity" size="2" value="<?php echo $minimum; ?>" />      
        ...
        <div><a class="wishlist" onclick="addToWishList('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a><br />
          <a class="wishlist" onclick="addToCompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a></div>
        <?php if ($minimum > 1) { ?>
      ...
      <div class="review">
        <div><img src="catalog/view/theme/bigshop/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div>
  ...
  <div class="box-content">
    <div class="box-product">
      ...
      <div>
        ...
        <div class="rating"><img src="catalog/view/theme/bigshop/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" /></div>
        <?php } ?>
