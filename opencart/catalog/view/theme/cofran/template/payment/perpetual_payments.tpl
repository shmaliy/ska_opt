...
<div id="paypal" style="background: #000000; border: 1px solid #FFFFFF; padding: 10px; margin-bottom: 10px;">
  <table width="100%">
    <tr>
  ...
  <div class="buttons-set">
    ...
    <button onclick="confirmSubmit();" id="paypal_button" class="button" type="button"><span><span><span><?php echo $button_confirm; ?></span></span></span></button>
  </div>
