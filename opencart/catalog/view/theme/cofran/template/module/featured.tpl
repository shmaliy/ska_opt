...
<div class="block block-related">
    ...
    <div class="block-content">
        <ol id="block-related">
	        ...
	        <li class="item odd">
	            <div class="item">
                    <a class="product-image" href="<?php echo str_replace('&', '&amp;', $product['href']); ?>" title="<?php echo $product['name']; ?>">
					...
					<span class="clear-img"></span></a>
    	                <div class="product-details">
        	                <h3 class="product-name">
                            	<a href="<?php echo str_replace('&', '&amp;', $product['href']); ?>" class="titulo"><?php echo $product['name']; ?></a>
                            </h3>
